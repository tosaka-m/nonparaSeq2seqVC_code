...
class ParrotLoss(nn.Module):
    def __init__(self,
                 ...
                 ce_loss,
                 n_frames_per_step_decoder,
                 n_symbols,
                 predict_spectrogram,
                 contrastive_loss_w,
                 speaker_encoder_loss_w,
                 text_classifier_loss_w,
                 speaker_adversial_loss_w,
                 speaker_classifier_loss_w):
        super(ParrotLoss, self).__init__()
        self.hidden_dim = encoder_embedding_dim
        ...
        self.contr_w = contrastive_loss_w
        self.spenc_w = speaker_encoder_loss_w
        self.texcl_w = text_classifier_loss_w
        self.spadv_w = speaker_adversial_loss_w
        self.spcla_w = speaker_classifier_loss_w
